...
const unis = [
  {
    ...
    logo: "/assets/images/kennedy_logo.png",
    websiteUrl: "https://www.kennedy.edu.eu/",
    country: "USA",
    location: "Florida, USA",
    partnershipType: "Academic",
    tagline: "High-quality, accessible distance and online education globally",
  ...
  },
  {
    ...
    logo: "/assets/images/kennedy_baptist_logo.png",
    websiteUrl: "https://www.kennedy.edu.eu/",
    country: "USA",
    location: "Florida, USA",
    partnershipType: "Academic",
    tagline: "Private, faith-based educational institution",
...
async function seed() {
  try {
    ...
    await University.insertMany(unis);
